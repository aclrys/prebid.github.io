...
{: .alert.alert-success :}
You can always get the latest version of the creative code below from [the Mobile example creative file in our GitHub repo](https://github.com/aclrys/prebid-universal-creative/blob/master/template/amp/dfp-creative.html).
